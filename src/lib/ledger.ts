...
export const EASTPASS_TIERS: EastpassTier[] = [
  ...
  { level: 1, name: "Basic",   requirement: 500,  boost: 2,  apy: 0.03 },
  { level: 2, name: "Pro",     requirement: 1500, boost: 4,  apy: 0.05 },
  { level: 3, name: "Elite",   requirement: 3000, boost: 7,  apy: 0.08 },
  { level: 4, name: "Galaxy",  requirement: 5000, boost: 10, apy: 0.12 },
];
